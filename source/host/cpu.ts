...
export class CPU extends Hardware { 
		...
		// Variable that counts number of instructions
		private instruction = 0;
		//Initializes step to be first step (fetch)
		private step = 1;
		// Points to memory location being read.
		private programCounter = 0;
		private zFlag = 0;

		//Initializes registers
		private Accumulator =0x0000;
		private xRegister = 0x00;
		private yRegister = 0x00;
		private instructionRegister = 0x00;
